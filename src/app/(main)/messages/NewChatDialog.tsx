...
import { Check, CircleSpark, Search, Xmark } from "iconoir-react";
      ...
      <DialogContent className="bg-card p-0">
        ...
        <div className="">
          ...
          <div className="h-96 overflow-y-auto">
            ...
            {isFetching && (
              <CircleSpark className="mx-auto my-3 animate-spin" />
            )}
            {isError && (
...
function SelectedUserTag({ user, onRemove }: SelectedUserTagProps) {
  return (
    ...
    >
      ...
      <p className="font-bold">{user.name}</p>
      <Xmark className="mx-2 size-5 text-muted-foreground" />
    </button>
  );
}
